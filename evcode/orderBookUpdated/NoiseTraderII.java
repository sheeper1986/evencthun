...
public class NoiseTraderII extends Agent
{
	...
	protected void setup()
	{
    	...
    	LogonMarket.addSubBehaviour(new NoiseTraderBehaviour(this,2000,buySideOrdersII, sellSideOrdersII, pendingOrderListII));
    		
    	addBehaviour(LogonMarket);
    	addBehaviour(new LocalOrderManager(buySideOrdersII, sellSideOrdersII, pendingOrderListII));
	 }
}
