...
public class RandomTradingBehaviour extends TickerBehaviour
{	
	private int id = 0;
	
	public RandomTradingBehaviour(Agent a, long period) 
	{
		super(a, period);
	}
	...
	protected void onTick()
	{
		...
		try
		{
			...
			InvestorAgent.pendingOrderList.add(newOrder);
			System.out.println("Pending orders " + InvestorAgent.pendingOrderList);
